...
public class ForecastUtils {
	...
	private static final String[] sIconAlert = new String[] { "alert",
			"advisory", "warning", "watch" };
	private static final String[] sIconStorm = new String[] { "thunder",
			"tstms" };
	private static final String[] sIconSnow = new String[] { "snow", "ice",
			"frost", "flurr", "wintry", "freez", "sleet", "blizzard", "cold" };
	private static final String[] sIconShower = new String[] { "rain" };
	private static final String[] sIconScatter = new String[] { "shower",
			"drizzle" };
	private static final String[] sIconClear = new String[] { "sunny",
			"breezy", "clear", "fair", "hot" };
	private static final String[] sIconClouds = new String[] { "cloud",
			"overcast" };
	private static final String[] sIconFog = new String[] { "fog", "haze",
			"smoke", "ash" };
	...
	public static int getIconForForecast(String conditions, boolean daytime) {
		...
		if (stringContains(conditions, sIconAlert)) {
			...
			if (stringContains(conditions, sIconShower)) {
				icon = R.drawable.weather_snow_rain;
			} else {
			...
			icon = daytime ? R.drawable.weather_clear
					: R.drawable.weather_clear_night;
		} else if (stringContains(conditions, sIconClouds)) {
			icon = daytime ? R.drawable.weather_few_clouds
					: R.drawable.weather_few_clouds_night;
		} else if (stringContains(conditions, sIconFog)) {
			icon = R.drawable.weather_mist;
		} else {
			icon = R.drawable.dialog_question;
		}
		return icon;
	}
	 ...
	 */
	public static boolean isDaytime(Time time) {
