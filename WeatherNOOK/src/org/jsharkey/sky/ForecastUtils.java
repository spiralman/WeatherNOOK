...
public class ForecastUtils {
    ...
    private static final String[] sIconSnow = new String[] { "snow", "ice", "frost", "flurr", "wintry", "freez", "sleet", "blizzard", "cold" };
    ...
    private static final String[] sIconClear = new String[] { "sunny", "breezy", "clear", "fair", "hot" };
    private static final String[] sIconClouds = new String[] { "cloud", "overcast" };
    private static final String[] sIconFog = new String[] { "fog", "haze", "smoke", "ash" };
