...
public class ForecastBinder implements ViewBinder {
	...
	public boolean setViewValue(View view, Object data, String textRepresentation) {
		...
		morning.setText(String.format(morningPrecipFormat, forecast.getMorningPrecip()));
		evening.setText(String.format(eveningPrecipFormat, forecast.getEveningPrecip()));
