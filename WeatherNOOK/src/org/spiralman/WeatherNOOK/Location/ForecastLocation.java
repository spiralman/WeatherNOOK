...
public class ForecastLocation {
	...
	public ForecastLocation(String json) throws JSONException {
		...
		m_station = new ObservationStation(
				location.getJSONObject("observation_station"));

		initialize();
	}

	public ForecastLocation(String city, String state, String name,
			double latitude, double longitude, ObservationStation station) {
		m_city = city;
		m_state = state;
		m_fullName = name;
		m_lat = latitude;
